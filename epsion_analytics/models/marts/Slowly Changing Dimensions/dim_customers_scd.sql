-- This table reads from the customers snapshot table and adds an `is_current` flag
...
-- history of customer profile changes in (email, income, marital status...etc) and over time.
